 ...
 * [FragmentCompat.OnRequestPermissionsResultCallback] interface
...
class CameraFragment : Fragment(), View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    private lateinit var pictureTakenCallback: PictureTakenCallback
    ...
    private val mSurfaceTextureListener = object : TextureView.SurfaceTextureListener {
        ...
        override fun onSurfaceTextureAvailable(texture: SurfaceTexture, width: Int, height: Int) {
            Log.i(TAG, "Relation in res. $width:$height, ${width.toFloat() / height}")
            openCamera(width, height)
        }

        override fun onSurfaceTextureSizeChanged(texture: SurfaceTexture, width: Int, height: Int) {
            Log.i(TAG, "Triggered TextureSizeChanged with $width:$height, ${width.toFloat() / height}")
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                mPreviewSize = chooseOptimalSize(map.getOutputSizes(SurfaceTexture::class.java),
                        ...
                        maxPreviewHeight, Size(9, 16))

                Log.i(TAG, "Optimal size was ${mPreviewSize?.width}:${mPreviewSize?.height}")
        ...
        try {
            ...
            val CaptureCallback = object : CameraCaptureSession.CaptureCallback() {
                ...
                override fun onCaptureCompleted(session: CameraCaptureSession,
                    ...
                    // Trigger callback on activity
                    pictureTakenCallback.pictureTaken(mFile)
    ...
    companion object {
        ...
        private fun chooseOptimalSize(choices: Array<Size>, textureViewWidth: Int,
            ...
            for (choice in bigEnough) {
                Log.i(TAG, "Big: $choice")
            }
            for (choice in notBigEnough) {
                Log.i(TAG, "Small: $choice")
            }
            Log.d(TAG, bigEnough.toString())

            // Pick the smallest of those big enough. If there is no one big enough, pick the
            // largest of those not big enough.
            if (bigEnough.size > 0) {
                Log.i(TAG, "There were big sizes")
                return Collections.min(bigEnough, CompareSizesByArea())
            } else if (notBigEnough.size > 0) {
                Log.i(TAG, "All sizes were too small")
    ...
    override fun onAttach(context: Context?) {
        ...
        pictureTakenCallback = context as PictureTakenCallback
    }
}
